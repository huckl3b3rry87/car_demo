...
void PriusHybridPlugin::OnPriusCommand(const vehicle_msgs::Control::ConstPtr &msg)
{
  ...
  {
    case vehicle_msgs::Control::NEUTRAL:
      this->dataPtr->directionState = PriusHybridPluginPrivate::NEUTRAL;
      break;
    case vehicle_msgs::Control::FORWARD:
      this->dataPtr->directionState = PriusHybridPluginPrivate::FORWARD;
      break;
    case vehicle_msgs::Control::REVERSE:
